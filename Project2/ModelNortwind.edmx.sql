...
-- --------------------------------------------------
-- Date Created: 02/19/2018 22:42:06
-- Generated from EDMX file: C:\Users\Bejn\Desktop\Project2\Project2\ModelNortwind.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_CustomerCustomerDemo_CustomerDemographics]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CustomerCustomerDemo] DROP CONSTRAINT [FK_CustomerCustomerDemo_CustomerDemographics];
GO
...
CREATE TABLE [dbo].[Employees] (
    ...
    [RepFN] nvarchar(max)  NOT NULL,
    [RepLN] nvarchar(max)  NOT NULL
);
GO
